...
const salesOrdersSchema = {
  ...
  SalesOrderCreateRequest: {
    ...
    properties: {
      ...
      subsidiary_name: { type: 'string', example: '' },
      ...
      currency_name: { type: 'string', example: '' },
      terms: { type: 'integer', example: 9 },
      terms_name: { type: 'string', example: '' },
      department: { type: 'integer', example: 101 },
      department_name: { type: 'string', example: '' },
      class: { type: 'integer', example: 3 },
      class_name: { type: 'string', example: '' },
      location: { type: 'integer', example: 19 },
      location_name: { type: 'string', example: '' },
