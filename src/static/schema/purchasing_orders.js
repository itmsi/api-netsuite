...
const purchasingOrdersSchemas = {
  ...
  PurchaseOrderLine: {
    ...
    properties: {
      ...
      subsidiary_name: {
        type: "string",
        example: "PT Indonesia Equipment Centre",
      },
  ...
  PurchaseOrder: {
    ...
    properties: {
      ...
      po_date: {
        type: "string",
        format: "date-time",
        example: "2026-03-25T00:00:00+07:00",
      },
      po_status: { type: "string", example: "A" },
      po_status_label: {
        type: "string",
        example: "Purchase Order : Pending Supervisor Approval",
      },
      ...
      created_at: {
        type: "string",
        format: "date-time",
        example: "2026-03-26T09:19:30.528Z",
      },
      updated_at: {
        type: "string",
        format: "date-time",
        example: "2026-03-26T09:48:21.451Z",
      },
      last_modified: {
        type: "string",
        format: "date-time",
        example: "2026-03-26T00:00:00+07:00",
      },
  ...
  PurchaseOrderDashboardItem: {
    ...
    properties: {
      ...
      nextapprover: {
        type: "string",
        example: "MSIJKT2311139 - Oscar Feriady Hadi Saputra",
      },
      po_status: { type: "string", example: "pendingSupApproval" },
      po_status_label: {
        type: "string",
        example: "Pending Supervisor Approval",
      },
    },
  },
  ...
  PurchaseOrderLineItem: {
    ...
    properties: {
      ...
      cseg_msi_pro_segmen: { type: "string", example: "2" },
    },
  },
  ...
  PurchaseOrderUpdateRequest: {
    ...
    properties: {
      ...
      memo: {
        type: "string",
        example: "PO from API - 26 Note Approved di edit lg ya",
      },
      currency: { type: "integer", example: 1 },
      terms: { type: "integer", example: 9 },
      custbody_me_pr_date: { type: "string", example: "24/03/2026" },
      ...
      custbody_msi_createdby_api: {
        type: "string",
        example: "dharmaridwan@motorsights.net",
        description: "Auto-populated from token if not provided",
      },
      class: { type: "integer", example: 3 },
      department: { type: "integer", example: 101 },
      custbody_me_validity_date: { type: "string", example: "24/03/2026" },
  ...
  PurchaseOrderApprovalResponse: {
    ...
    properties: {
      ...
      message: {
        type: "string",
        example: "Note created first, record updated & workflow triggered",
      },
      data: {
        type: "object",
        properties: {
  ...
  PurchaseOrderDetailResponse: {
    ...
    properties: {
      ...
      timestamp: {
        type: "string",
        format: "date-time",
        example: "2026-04-01T06:26:20.856Z",
      },
    },
  },
  ReceiveListRequest: {
    ...
    properties: {
      ...
      search: {
        ...
        example: "",
        description:
          "Filter untuk tranid, vendor_name, subsidiary_display, location_display",
      },
      classes: {
        type: "string",
        default: "",
        example: "",
        description: "Filter untuk kolom class",
      },
      subsidiary: {
        type: "string",
        default: "",
        example: "",
        description: "Filter untuk kolom subsidiary",
      },
      location: {
        type: "string",
        default: "",
        example: "",
        description: "Filter untuk kolom location",
      },
      vendor_id: {
        type: "string",
        default: "",
        example: "",
        description: "Filter untuk kolom vendor_id",
      },
      receipt_ids: {
        type: "array",
        items: { type: "string" },
        example: ["10361"],
        description: "Filter untuk list receipt ID",
      },
      tranid: {
        type: "string",
        default: "",
        example: "",
        description: "Filter untuk kolom tranid",
      },
      createdfrom_text: {
        type: "string",
        default: "",
        example: "PO-",
        description: "Filter untuk kolom createdfrom_text",
      },
      createdfrom: {
        type: "integer",
        default: 5512,
        example: 5512,
        description: "Filter untuk kolom createdfrom",
      },
    },
  },
};
