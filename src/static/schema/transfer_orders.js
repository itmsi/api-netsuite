...
const transferOrdersSchema = {
  TransferOrderListRequest: {
    ...
    properties: {
      ...
      search: { type: 'string', description: 'Cari di tranid, netsuite_id, atau memo', example: 'Transfer order memo' },
      location: { type: 'integer', description: 'Filter by from_location_id', example: 1 },
      transferlocation: { type: 'integer', description: 'Filter by to_location_id', example: 4 },
  ...
  TransferOrder: {
    ...
    properties: {
      ...
      from_location_name: { type: 'string', nullable: true, example: 'Warehouse A' },
      to_location_id: { type: 'integer', example: 4 },
      to_location_name: { type: 'string', nullable: true, example: 'Warehouse B' },
      memo: { type: 'string', example: 'Transfer order memo' },
      tran_date: { type: 'string', example: '31/12/2026' },
      datecreated: { type: 'string', nullable: true, example: '2026-08-24T07:44:27.781Z' },
      last_modified_netsuite: { type: 'string', nullable: true, example: '2026-08-24T07:44:27.781Z' },
      items: {
        type: 'array',
      ...
      data: {
        type: 'object',
        description: 'Field tambahan dari payload (customform, subsidiary, department, class, status, incoterm, employee)',
        properties: {
