        ...
        .select([
          ...
          jsonb_agg(
            jsonb_build_object(
                ...
                ---- di buat 0 karena di prod tidak akan di tampilkan harganya dan ini data sensitif 'transfer_price', COALESCE(NULLIF(line->>'transfer_price', ''), line->>'rate'),
                ---- di buat 0 karena di prod tidak akan di tampilkan harganya dan ini data sensitif 'amount', line->>'amount',
                'transfer_price', 0,
                'amount', 0,
                'units', line->>'units',
