...
module.exports = {
  ...
  EXCHANGES: {
    ...
    PURCHASE_ORDER_CREATE: "purchase-order-create-v5",
    PURCHASE_ORDER_UPDATE: "purchase-order-update-v5",
  ...
  QUEUE: {
    ...
    PURCHASE_ORDER_CREATE: "purchase-order-creation-v5",
  ...
  OFFICIAL_ADDRESS:
    process.env.OFFICIAL_ADDRESS ??
    "Jl Moh Kahfi I No 24.A RT/RW 008/006 jagakarsa, jagakarsa. Jakarta selatan, kode pos 12620",
  ...
  LAST_DATE_EXISTING: (
    process.env.LAST_DATE_EXISTING || "2024-12-31"
  ).toString(),
  ...
  SYNC_CONFIG: {
    ...
    project_segmentations: {
      url: `${process.env.BRIDGE_BASE_URL || "http://localhost:9570"}/api/v1/bridge/project-segmentations/get`,
      data: {
        page: 1,
        page_size: 10,
        is_sync: true,
